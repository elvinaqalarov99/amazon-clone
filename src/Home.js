    ...
    <div className="home">
      <div className="home__container">
        ...
        <div className="home__row">
          ...
          <Product
            id="49538094"
            title="Kenwood kMix Stand Mixer for Baking, Stylish, Kitchen Mixer with K-beater, Dough Hook and Whisk, 5 Litres Glass Bowl"
            price={239.0}
            rating={4}
        ...
        <div className="home__row">
          <Product
            id="4903850"
            title="Honor Band 5 Fitness Tracker Heart Rate Monitor AMOLED 0.95 Inch Smart Watch 5ATM Waterproof Bluetooth 4.2 (Black)"
            price={28.99}
            rating={3}
